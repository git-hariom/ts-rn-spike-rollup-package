...
var Button = function (_a) {
    ...
    var styles = function () {
        var _a;
        var propStyle = (_a = props.style) !== null && _a !== void 0 ? _a : {};
        if (props.disabled)
            return propStyle;
        if (variant === "primary")
            return __assign({ borderColor: "#6366F1", backgroundColor: "#6366F1", color: "#FAFAFA" }, propStyle);
        if (variant === "secondary")
            return __assign({ borderColor: "#6366F1", backgroundColor: "#FAFAFA", color: "#6366F1" }, propStyle);
        return propStyle;
    };
    return (jsxRuntimeExports.jsx("button", __assign({}, props, { style: styles() }, { children: props.children })));
};
