...
const Button = (_a) => {
    ...
    const styles = () => {
        var _a;
        const propStyle = (_a = props.style) !== null && _a !== void 0 ? _a : {};
        if (props.disabled)
            return propStyle;
        if (variant === "primary")
            return Object.assign({ borderColor: "#6366F1", backgroundColor: "#6366F1", color: "#FAFAFA" }, propStyle);
        if (variant === "secondary")
            return Object.assign({ borderColor: "#6366F1", backgroundColor: "#FAFAFA", color: "#6366F1" }, propStyle);
        return propStyle;
    };
    return (jsxRuntimeExports.jsx("button", Object.assign({}, props, { style: styles() }, { children: props.children })));
};
